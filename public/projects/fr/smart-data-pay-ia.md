...
description:
  title: Description
  content: "<p>Assistant intelligent (chatbot RAG / IA) pour comprendre et maîtriser la paie, le droit du travail et les conventions collectives en France. J'ai travaillé sur les premières versions, avec un accent particulier sur le chatbot RAG.</p>"
  button:
    label: Voir l'application
    link: https://www.smartdatapay.app/
details:
  title: Détails du projet
  items:
    - label: Période
      value: Depuis Avr. 2024
    - label: Statut
      value: En cours
    - label: Client
      value: YSO Conseils
    - label: Rôle
      value: Développeur — accent chatbot RAG IA
    - label: Stack
      value: Next.js, OpenAI, Ollama, LiteLLM, LangChain
    - label: Lieu
      value: France
carousel:
  - image: /img/projects/smart-data-pay-ia/1.png
