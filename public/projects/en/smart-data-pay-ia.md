...
description:
  title: Description
  content: "<p>Intelligent assistant (RAG / AI chatbot) to understand and master payroll, labour law and collective agreements in France. I worked on the first versions, with a particular focus on the RAG chatbot.</p>"
  button:
    label: Open the app
...
details:
  ...
  items:
    ...
    - label: Client
      value: YSO Conseils
    - label: Role
      value: Developer — focus on the RAG AI chatbot
    - label: Stack
