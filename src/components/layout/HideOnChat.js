...
// Pages où le bouton CV flottant est aussi masqué : accueil (le hero a déjà son bouton CV),
// Kamitbrains, contact et tout le blog (liste + articles), où il gênait la lecture ou
// doublait les actions de la page.
